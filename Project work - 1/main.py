#Developed by Muhammad Jihab Monoar, Roll: 685824, Department: Computer, Section: B1, Shift: 1st, Session: 2021-2022.
...
label_info_rect=label_info.get_rect(center=(300,50))
...
pg.display.set_caption("Tik Tac Toe By Muhammad Jihab Monoar (685824)")
...
def restart():
    global is_player1_chance,someone_won,pos,chance_count,result,pieces,matrix,label_info, winner
    is_player1_chance=True
    someone_won=False
    pos=(0,0)
    chance_count=0
